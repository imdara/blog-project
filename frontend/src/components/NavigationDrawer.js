...
const NavigationDrawer = () => {
  ...
  const navigation = [
    ...
    { name: "Add Blog", path: "/create-blog", current: false },
    { name: "My Blogs", path: "/my-blogs", current: false },
  ];
          ...
          <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex-shrink-0 flex items-center text-lg font-medium text-slate-50">
                  {token ? `Welcome ${name}` : "My site"}
                </div>
                {token && (
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <Menu as="div" className="ml-3 relative">
                  <div>
                    <Menu.Button className="bg-slate-600 flex ">
                      <span className="sr-only">Open user menu</span>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-8 w-8 p-0.5 text-slate-200 hover:bg-gray-700 rounded-md hover:text-white"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        stroke-width="2"
